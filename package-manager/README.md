...
* [`jammy`, `ubuntu2204`, `jammy-2026.04.2`, `ubuntu2204-2026.04.2`](https://github.com/rstudio/rstudio-docker-products/blob/main/package-manager/Dockerfile.ubuntu2204)
...
RStudio License Manager 2026.04.2+764.pro1
...
❯ docker ps
CONTAINER ID   IMAGE ...
b8ae944b7f2d   rstudio/rstudio-package-manager:2026.04.2-3 ...
```
