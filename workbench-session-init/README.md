...
* [`jammy-daily`, `ubuntu2204-daily`, `jammy-2026.05.1`, `ubuntu2204-2026.05.1`](https://github.com/rstudio/rstudio-docker-products/blob/main/workbench-session-init/Dockerfile.ubuntu2204)
