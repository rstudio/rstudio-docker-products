...
* [`jammy-daily`, `ubuntu2204-daily`, `jammy-2026.04.0`, `ubuntu2204-2026.04.0`](https://github.com/rstudio/rstudio-docker-products/blob/main/workbench-session-init/Dockerfile.ubuntu2204)
