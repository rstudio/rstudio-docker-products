...
1. The images themselves are not currently supported by the RStudio support team. You can ask questions of support if you are using these images, but the support team will not be able to help you with questions about the images.
