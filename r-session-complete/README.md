...
* [`jammy`, `ubuntu2204`, `jammy-2026.08.1`, `ubuntu2204-2026.08.1`](https://github.com/rstudio/rstudio-docker-products/blob/main/r-session-complete/Dockerfile.ubuntu2204)
