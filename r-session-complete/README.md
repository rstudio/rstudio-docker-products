...
* [`jammy`, `ubuntu2204`, `jammy-2026.06.0`, `ubuntu2204-2026.06.0`](https://github.com/rstudio/rstudio-docker-products/blob/main/r-session-complete/Dockerfile.ubuntu2204)
